...
export default function AddRouteClient() {
  ...
  const handlePlaceSelect = useCallback((place: PlaceResult) => {
    setSearchLocation([place.lng, place.lat]);
  }, []);
  ...
  return (
    <div className="flex flex-col gap-4 flex-1">
      ...
      <div className="flex flex-col lg:flex-row gap-6 flex-1">
        <div className="rounded-xl overflow-hidden border border-border h-[50vh] lg:h-[calc(100vh-18rem)] lg:flex-1">
          <MapRouteDraw
          ...
          {routeCoords ? (
            ...
            <div className="rounded-xl border border-border bg-card p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Use the map to draw a closed route, then fill in the details
                here.
              </p>
            </div>
          )}
